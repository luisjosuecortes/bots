...
REGIMEN_LOOKBACK_MIN = 90  # ventana para medir el régimen (tendencia reciente)
REGIMEN_MIN_PCT = -2.0     # solo pausa en free-fall REAL. Caídas moderadas históricamente rebotan;
                           # el umbral es seguro de cola ante un bear sostenido fuera de muestra.
...
REFRESH_HORAS = 24
INTERVALO_CHEQUEO = 30  # Optimizado: balance entre detección y carga
VENTANA_MINUTOS = 15
...
def generar_slug():
    ...
    return f"btc-updown-15m-{int(inicio.timestamp())}"
    ...
    async with aiohttp.ClientSession() as session:
        ...
        while True:
            try:
                ...
                prob = probabilidad_temporal(TABLA, "15m", elapsed_min, caida_pct)
